...
class GameScene: SKScene {
    ...
    private func constrainGameArea(){
    ...
    private func catchPlayer(_ bot: Bot){
    ...
    private func move(_ sprite: SKSpriteNode, _ location: CGPoint){
    ...
    private func getDirection(for value: CGFloat) -> Direction{
